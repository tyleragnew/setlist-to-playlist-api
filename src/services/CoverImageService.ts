...
export class CoverImageService {
  ...
  constructor() {
    ...
    this.faviconBuffer = fs.readFileSync(path.join(assetsDir, 'favicon.png'));
  }
  ...
  async generateCoverImage(
    ...
    // 2. Build favicon for upper-right corner
    const iconSize = 64;
    const margin = 30;
    const faviconPng = await sharp(this.faviconBuffer)
    ...
    const finalImage = await sharp(artistImgBuffer)
      .composite([
        ...
        { input: faviconPng, top: margin, left: size - margin - iconSize },
      ])
      .jpeg({ quality: 90 })
      .toBuffer();
